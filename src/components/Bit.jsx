...
import BitMobile from "../components/mobile/BitMobile";
const Bit = () => {
  ...
  return (
    <div>
      {isMobile ? (
        ...
        <div className="bg-white rounded-md py-5 relative">
          <div className="flex ml-8 text-[23px]">
            ...
            <h3 className="bg-gray-400 text-white rounded-md m-2 mt-0 p-2 ml-6 text-[13px]">
              Rank #1
            </h3>
          </div>
          <div className="flex">
